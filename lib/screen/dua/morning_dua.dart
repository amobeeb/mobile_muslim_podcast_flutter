...
class MorningDua extends StatelessWidget {
  const MorningDua({Key key}) : super(key: key);
static const String routeName = '/morning_dua';
  @override
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                // third column Menu
                CustomDuaList('/morning_dua_details')
