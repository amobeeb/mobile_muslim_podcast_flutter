...
class EveningDua extends StatelessWidget {
  const EveningDua({Key key}) : super(key: key);
static const String routeName = '/evening_dua';
  @override
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                // third column Menu
                CustomDuaList('/evening_dua_details')
